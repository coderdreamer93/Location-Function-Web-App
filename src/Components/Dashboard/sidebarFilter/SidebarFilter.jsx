...
// //   // ✅ Multi-select enabled only if operation is AND/OR
// //   const isMultiSelect =
// //     selectedOperation === "AND" || selectedOperation === "OR";

// //   // ✅ Apply Filters (sends clean structured data)
// //   const applyFilters = () => {
// //     const cleanLocations = selectedLocation.filter(
...
// //       logic: selectedOperation === "AND" ? "AND" : "OR",
// //     });
...
// //   // ✅ Sidebar Search (does not affect alphabet filter)
...
// //   // ✅ Handle alphabet click (only filters main business data)
...
// //             multiSelect={true} // ✅ always multi-select for locations
// //           />
// //           <FilterSection
// //             title="Operations"
...
//   const [activeLetter, setActiveLetter] = useState("");
//   const [searchTerm, setSearchTerm] = useState("");
//   const cycleIndexRef = useRef(0); // ✅ for OR rotation

//   const isMultiSelect =
//     selectedOperation === "AND" || selectedOperation === "OR";

//   const applyFilters = () => {
//     let appliedLocations = selectedLocation;

//     // 🌀 OR logic → show one city at a time, rotate only if multiple are selected
//     if (selectedOperation === "OR" && selectedLocation.length > 1) {
//       const index = cycleIndexRef.current % selectedLocation.length;
//       appliedLocations = [selectedLocation[index]];
//       cycleIndexRef.current += 1; // move to next for next Apply
//     }

//     const appliedData = {
//       location: appliedLocations,
//       operation: selectedOperation,
//       business: selectedBusiness,
//       type: selectedType,
//       formulaUsage: selectedFormulaUsage,
...
//   // 🔍 Filter sidebar lists by search term
//   const filteredData = useMemo(() => {
//     const match = (item) =>
//       item.toLowerCase().includes(searchTerm.toLowerCase());
//     return {
      ...
      <div className="flex w-full">
        <div className="flex flex-col w-full">
          <FilterSection
            ...
            selected={selectedLocation}
            onSelect={setSelectedLocation}
            multiSelect={isMultiSelect || true} // ✅ always allow multi-select for locations
          />
          <FilterSection
            title="Operations"
            options={filteredData.operations}
