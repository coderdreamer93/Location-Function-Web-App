...
// // const SidebarFilter = ({locations, operations, businesses, types, formulaUsage, alphabet}) => {
...
// //           {/* FormulaUsage Filter */}
// //           {formulaUsage && <div className="mb-4">
// //             <span className="text-xs font-semibold text-gray-400 mb-2 uppercase tracking-wide">
// //               Formula Usage
// //             </span>
// //             <ul className="ml-0 pl-0 space-y-1">
...
//   // ✅ Send updated filters to parent whenever something changes
//   useEffect(() => {
//     if (onFilterChange) {
//       onFilterChange({
...
//           {formulaUsage.length > 0 && (
//             <FilterSection
//               title="Formula Usage"
//               options={formulaUsage}
...
// // ✅ Reusable small filter block component
