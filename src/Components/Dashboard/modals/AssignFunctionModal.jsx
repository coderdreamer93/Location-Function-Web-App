            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-2 justify-center">
                  ...
                  <span className=" text-[14px] newFontColor leading-[1.1] mt-[1px]">
                    {user.location || "Los Angeles, CA, USA"}
                  </span>
                  <div className="flex gap-1">

                  <span className=" text-[14px] newFontColor font-semibold leading-[1.1] mt-[1px]">
                    Problem 
                  </span>
                  <span className="text-red-700 text-[14px] font-semibold leading-[1.1] mt-[1px]">
