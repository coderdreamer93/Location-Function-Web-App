...
import ListAndGrid from "../../../Components/Dashboard/header/nestedHeader/ListAndGrid";
...
export default function BusinessAppointmentView() {
  ...
  return (
    <div className="relative w-screen h-screen bg-gray-50 overflow-hidden flex flex-col">
      ...
      {/* Header */}
      <div className="w-full flex justify-end items-center bg-white p-4 shadow-sm z-20">
        <ListAndGrid title="" view={view} setView={setView} />
      </div>
      ...
      <div className="flex flex-col md:flex-row w-full h-full">
        ...
        <div className="w-12 ">
          <img src="/src/Assets/icons/ProblemPC.png" alt="" />
        </div>
        ...
        {/* Info Card */}
        <div className="w-full sm:w-[360px] absolute md:static top-[90px] right-0 
