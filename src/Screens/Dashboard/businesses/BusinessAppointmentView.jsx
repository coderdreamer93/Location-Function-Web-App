...
import { ReactComponent as SolutionMonitorIcon } from "../../../Assets/icons/solutionMonitorIcon.svg";
import { ReactComponent as ProblemMonitorIcon } from "../../../Assets/icons/problemMonitorIcon.svg";
import { ReactComponent as DateBlueIcon } from "../../../Assets/icons/dateBlueIcon.svg";

export default function BusinessAppintmentView() {
      ...
      <div className="flex flex-col md:flex-row w-full h-full relative">
        ...
        >
          ...
          <div
            ...
            "
          >
            <div className="w-[60px] h-[60px] md:w-[100px] md:h-[100px] flex justify-center items-center">
              <ProblemMonitorIcon className="w-full h-full" />
            </div>
          </div>
          ...
          >
            <div className="w-[60px] h-[60px] md:w-[100px] md:h-[100px] flex justify-center items-center">
              <SolutionMonitorIcon className="w-full h-full" />
            </div>
          </div>
        </div>
