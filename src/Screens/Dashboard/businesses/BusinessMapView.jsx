...
//               <img src="/UserImage.png" alt="Mechanic Picture" />
//             </div> */}
//           </div>

//           {/* Arrow */}
//           <div className="absolute z-20 left-[150px] w-[150px] h-[150px] sm:top-[230px] rotate-[5deg]">
//             <ArrowIcon />
//           </div>

//           {/* Distance */}
//           <div className="absolute z-20 left-[270px] top-[140px] bg-white text-blue-500 text-sm font-semibold px-2 py-1 rounded shadow flex items-center">
//             <DistanceIcon />
//             <span className="ml-1">200 mile</span>
//           </div>
